...
public class CountTriplets {
    ...
    static long countTriplets(List<Long> arr, long r) {
        ...
        for (long num : arr) {
            ...
            if (potentialPairs.containsKey(num)) {
                completedTriplets.put(num * r, completedTriplets.getOrDefault(num * r, 0L) + potentialPairs.get(num));
            }

             // This number could be the *first* element of a triplet.
            // Update the count of potential *second* elements.
            potentialPairs.put(num * r, potentialPairs.getOrDefault(num * r, 0L) + 1);
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(countTriplets(Arrays.asList(1L, 3L, 9L, 9L, 27L, 81L), 3)); // Expected: 6
        System.out.println(countTriplets(Arrays.asList(1L, 5L, 5L, 25L, 125L), 5)); // Expected: 4
        ...
        System.out.println(countTriplets(Arrays.asList(1L,1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L), 1)); //Expected 161700
